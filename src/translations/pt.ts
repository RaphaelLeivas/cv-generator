const pt = {
  ...
  technologyConsultant1:
    'Execução de tarefas em desenvolvimento de sistemas Web, com metodologia Scrum, usando NodeJS, React, ExpressJS.',
  trainee: 'Trainee',
  trainee1: 'Aprendizado em desenvolvimento de sistemas Web e metodologia Scrum.',
  ...
  cefet2: 'Certificação nível Avançado - II em Língua Inglesa pela Fundação CEFET Minas.',
  languages: 'Idiomas',
